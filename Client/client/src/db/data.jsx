...
const gettutors = async () => {
  ...
  for(let i = 0; i < data2.length; i++){
    ...
    for(let j = 0; j < data2[i].languages.length; j++){
      ...
      data.push({language, name, duration:duration1, cost:cost1, yearsOfExperience, startTime, endTime});
      data.push({language, name, duration:duration2, cost:cost2, yearsOfExperience, startTime, endTime});
      data.push({
        language,
        name,
        duration:duration3,
